function Carousel(selector){
    ...
    this.buildTrack = function(){
        ...
        this.track.style.height = this.slideHeight +'px';
    ...
    this.setSlidePosition = function(slide, i){
        ...
        if(boxSizing === 'border-box'){
            ...
            var paddingBottom = css(slide, 'padding-bottom');
            var borderTop = css(slide, 'border-top-width');
            ...
            var height = this.slideHeight - (paddingTop + borderTop + paddingBottom + borderBottom);
