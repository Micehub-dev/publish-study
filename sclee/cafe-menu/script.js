...
function renderItems(list){
    list.forEach(function(item){
        ...
        // getCategory 함수에서, item의 현재category에 해당하는 HTML이
...
function getCategory(item){
    ...
    var category = menu.querySelector(".category."+categoryClass); // 없으면 null 이 category에 저장됨
